...
def latin_hypercube_sampling(n_samples:int , dimension:int, lower_bounds:List[float], upper_bounds:List[float]):
    """
...
def latin_hypercube(fun, n_samples:int , dimension:int, lower_bounds:List[float], upper_bounds:List[float]):

    X_log = latin_hypercube_sampling(n_samples=n_samples , dimension=dimension, lower_bounds=lower_bounds, upper_bounds=upper_bounds)
    Y_log = fun(X_log.T)
